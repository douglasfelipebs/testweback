...
import { cardNoticia, panelNotice, cardImg, textoNoticia } from './Layout.css'
...
CardNoticia.propTypes = {
    ...
    imgDescricao: PropTypes.string.isRequired,
    corpoTexto  : PropTypes.string.isRequired
}
